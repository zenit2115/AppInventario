  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Modificar Configuración</h4>
      </div>
      <div class="modal-body">
			<div id="datos_ajax"></div>
				<div class="form-group">
					<label for="icconfiguracion_ruta" class="control-label">RUT INSTITUCIÓN</label>
                   
                    <!--HAY QUE AGREGAR ESTA LINEA-->
                    <input type="hidden" class="form-control" id="icp_id_configuracion" name="icp_id_configuracion">
				   
                    <input type="text" name="icconfiguracion_ruta" class="form-control" id="icconfiguracion_ruta" placeholder="RUT Proveedor" maxlength="12"  rel="popover" data-container="body" data-toggle="popover" data-placement="right"  pattern="^[0-9]{1,2}[\.]{1}[0-9]{3}[\.]{1}[0-9]{3}[-]{1}[0-9a-zA-Z]{1}$" title="  <img src='../../images/precaucion.png' alt='precaución' style='height:20px; width:20px;'> Precaucion" data-content="Debes agregar un RUT en este estilo, 51.123.456-1">
				</div>
			...
			<div class="form-group">
				...
				<div class="form-group">
				<label for="icconfiguracion_cedulaa" class="control-label">RUT DIRECTOR</label>
					<input type="text" name="icconfiguracion_cedulaa" class="form-control" id="icconfiguracion_cedulaa" placeholder="RUT Director" maxlength="12" 
