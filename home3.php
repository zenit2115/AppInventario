...
if(/*isset*/($_SESSION['prueba']=='asistente')) {
...
<body>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right"> 
                ...
                <li class="dropdown navbar_dropdown">
                  ...
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Bienvenido Asistente<span class="caret"></span></a>
    ...
    <li role="presentation" class="active"><a class="ajax-link" href="fuentes/ayuda/index.php" target="miIframe"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span>  Módulo Ayuda</a></li> 
    ...
    <li role="presentation" class="active"><a class="ajax-link" href="fuentes/moduloSubCategorias/index.php" target="miIframe"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span>  Módulo tipo de subcategorias</a></li>
        ...
        <!--<div class=" col-lg-10 embed-responsive embed-responsive-16by9" >-->

		<div class="col-lg-10 embed-responsive embed-responsive-4by3" >

        	

			<iframe class="embed-responsive-item" name="miIframe" src="home2.php" style="border:none;"></iframe>
